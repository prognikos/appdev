// this header file contains constant definitions and functions declarations
// for manipulating sound, specifically .wav files.
//#define SDEBUG
...
typedef struct{
	...
	int chunkSize;		 		  // indicates how big should data is
